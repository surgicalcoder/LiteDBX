...
/// <summary>
/// The main exception for LiteDBX
/// </summary>
public class LiteException : Exception
{
    ...
    /// </summary>
    public bool IsCritical => ErrorCode >= 900;
    ...
    {
        return new LiteException(INVALID_DATABASE, "File is not a valid LiteDBX database format or contains a invalid password.");
    }
