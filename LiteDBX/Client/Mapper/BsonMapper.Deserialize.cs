...
public partial class BsonMapper
{
        ...
        else if (value.IsDocument)
        {
            ...
            if (entity.CreateInstance == null)
            {
                entity.CreateInstance =
                    GetTypeCtor(entity) ??
                    (v => Reflection.CreateInstance(entity.ForType));
            }
    ...
    private object DeserializeAnonymousType(Type type, BsonDocument value)
    {
        ...
        foreach (var par in ctor.GetParameters())
        {
            ...
            {
                arg = Deserialize(par.ParameterType, id);
            }
    ...
    // direct bson types
    private readonly HashSet<Type> _bsonTypes = new()
    {
        typeof(string),
        typeof(int),
        typeof(long),
    ...
    private readonly HashSet<Type> _basicTypes = new()
    {
        typeof(short),
        typeof(ushort),
        typeof(uint),
